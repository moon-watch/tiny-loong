...
//icache
    ...
    assign icache_index_buf   = pc_reg[11:4];
    assign icache_tag[19:17]  = direct_access ? pc_reg[31:29]
                                : dmw0_hit ? dmw0_pseg
                                : dmw1_hit ? dmw1_pseg
                                : tlb_ppn[19:17];
    assign icache_tag[16:9 ]  = (direct_access || dmw_hit) ? pc_reg[28:21]
                                : tlb_ppn[16:9];
    assign icache_tag[ 8:0 ]  = (direct_access || dmw_hit || tlb_ps) ? pc_reg[20:12]
                                : tlb_ppn[8:0];        //Sucks :(
    assign icache_offset_buf  = pc_reg[3:0];
//fsm
    assign any_excp     = if_any_ex;
    assign stall_now    = any_excp;
    assign fetch_valid  = (is_expired && ~stall_flag) || ((is_fresh || is_hold) && id_allowin);
    assign mem_cancel   = is_fresh && any_excp;
